...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=:+94771966060\n' // WhatsApp ID + phone number
            + 'END:VCARD'
prefix = '.'
blocked = []

const config = {
        botname: 'A R Abdulla', // Your Name Bot
        oname: 'A R Abdulla' // Your Name
}
...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = ["94771966060@s.whatsapp.net"] // replace this with your number
